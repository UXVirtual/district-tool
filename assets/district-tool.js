...
define('district-tool/components/aframe/raw/block-cursor', ['exports', 'aframe'], function (exports, _aframe) {
    'use strict';
...
define('district-tool/components/aframe/raw/colorize', ['exports'], function (exports) {
    'use strict';
...
define('district-tool/components/aframe/raw/spawn-in-circle', ['exports'], function (exports) {
    'use strict';
...
define('district-tool/routes/editor', ['exports', 'aframe', 'npm:aframe-extras', 'district-tool/components/aframe/raw/environment-ground-texture', 'district-tool/components/aframe/raw/intersection-spawn', 'district-tool/components/aframe/raw/snap', 'district-tool/components/aframe/raw/spawn-in-circle', 'district-tool/components/aframe/raw/scene', 'district-tool/components/aframe/raw/block-cursor', 'district-tool/components/aframe/raw/colorize', 'npm:super-hands', 'npm:aframe-environment-component', 'npm:aframe-star-system-component', 'npm:networked-aframe', 'npm:aframe-event-set-component', 'npm:aframe-layout-component', 'npm:aframe-select-bar-component', 'npm:aframe-randomizer-components', 'npm:aframe-gblock'], function (exports, _aframe, _npmAframeExtras, _environmentGroundTexture, _intersectionSpawn, _snap, _spawnInCircle, _scene, _blockCursor, _colorize) {
    'use strict';
    ...
    if (!_aframe.default.components['gltf-model-next']) {
        _aframe.default.registerComponent('gltf-model-next', _npmAframeExtras.default.loaders['gltf-model-next']);
    }
    ...
    if (!_aframe.default.components['spawn-in-circle']) {
        _aframe.default.registerComponent('spawn-in-circle', _spawnInCircle.default);
    }

    if (!_aframe.default.components['colorize']) {
        _aframe.default.registerComponent('colorize', _colorize.default);
    }

    if (!_aframe.default.components['block-cursor']) {
        _aframe.default.registerComponent('block-cursor', _blockCursor.default);
    }

    if (!_aframe.default.systems['scene']) {
        _aframe.default.registerSystem('scene', _scene.default);
    }
